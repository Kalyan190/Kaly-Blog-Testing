         ...
         <div className='grid md:grid-cols-3 gap-4'>
            <Card>
               ...
               <CardContent>
                  ...
                  <p className='text-muted-foreground text-sm mt-1'>+5 from last month</p>
               </CardContent>
            </Card>
            ...
            <Card>
               ...
               <CardContent>
                  ...
                  <p className='text-muted-foreground text-sm mt-1'>12 awaiting moderation</p>
               </CardContent>
            </Card>
            ...
            <Card>
               ...
               <CardContent>
                  ...
                  <p className='text-muted-foreground text-sm mt-1'>+0.6 from last month</p>
               </CardContent>
            </Card>
         </div>
