...
const HeroSection = () => {
   return (
      <section className="relative min-h-[600px] w-full overflow-hidden bg-gradient-to-br from-purple-950 via-indigo-950 to-indigo-950">
         ...
         <div className="container relative mx-auto flex h-full flex-col items-center justify-center px-4 py-24 md:flex-row md:py-32 max-w-6xl">
            {/* Content */}
            <div className="flex-1 space-y-8 text-center md:text-left">
               ...
               <div className="grid grid-cols-3 gap-4 pt-8 text-white md:max-w-md">
                  <div className="space-y-2">
                     <div className="text-2xl font-bold dark:text-white">1K+</div>
                  ...
                  <div className="space-y-2">
                     <div className="text-2xl font-bold dark:text-white">10M+</div>
            ...
            <div className="mt-12 flex-1 md:mt-0">
               ...
               >
                  <Image src={"https://plus.unsplash.com/premium_photo-1681666713689-cd1416a652f8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cGN8ZW58MHx8MHx8fDA%3D"} alt='image' className='object-cover' fill />
               </div>
            </div>
         </div>
      </section>
